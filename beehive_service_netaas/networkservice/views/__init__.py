...
class DeleteNetworkService(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': DeleteNetworkServiceResponseSchema
        }
    })
...
class NetworkServiceAPI(ApiView):
    ...
    def register_api(module, rules=None, **kwargs):
        ...
        rules = [
            ...
            ('%s/networkservices/describeaccountattributes' % base, 'GET', DescribeAccountAttributes, {}),
            ('%s/networkservices/modifyaccountattributes' % base, 'PUT', ModifyAccountAttributes, {})
        ]
