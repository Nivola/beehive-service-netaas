...
class DescribeInternetGatewaysResponseSchema(Schema):
    DescribeInternetGatewaysResponse = fields.Nested(
        DescribeInternetGatewaysResponse1Schema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class DescribeInternetGateways(ServiceApiView):
    ...
    def get(self, controller, data, *args, **kwargs):
        ...
        res, total = controller.get_service_type_plugins(
            service_uuid_list=gateway_id_list,
...
class CreateInternetGateway(ServiceApiView):
    ...
    def post(self, controller, data, *args, **kwargs):
        ...
        if service_definition_id is None:
            service_definition = serviceController.get_default_service_def(ApiNetworkGateway.plugintype)
        else:
            service_definition = serviceController.get_service_def(service_definition_id)
...
class DeleteInternetGatewayResponseSchema(Schema):
    DeleteInternetGatewayResponse = fields.Nested(
        DeleteInternetGatewayResponseItemSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class DeleteInternetGateway(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses(
        {200: {"description": "success", "schema": DeleteInternetGatewayResponseSchema}}
    )
...
class AttachInternetGatewayResponseSchema(Schema):
    AttachInternetGatewayResponse = fields.Nested(
        AttachInternetGateway1ResponseSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class DetachInternetGatewayResponseSchema(Schema):
    DetachInternetGatewayResponse = fields.Nested(
        DetachInternetGateway1ResponseSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class CreateInternetGatewayBastionResponseSchema(Schema):
    CreateInternetGatewayBastionResponse = fields.Nested(
        CreateInternetGatewayBastion1ResponseSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class DeleteInternetGatewayBastionResponseSchema(Schema):
    DeleteInternetGatewayBastionResponse = fields.Nested(
        DeleteInternetGatewayBastion1ResponseSchema,
        required=True,
        many=False,
        allow_none=False,
    )
...
class NetworkGatewayAPI(ApiView):
    ...
    def register_api(module, dummyrules=None, **kwargs):
        ...
        rules = [
            ...
            (
                "%s/describinternetgatewayebastion" % base,
                "GET",
                DescribeInternetGatewayBastion,
                {},
            ),
            (
                "%s/createinternetgatewaybastion" % base,
                "POST",
                CreateInternetGatewayBastion,
                {},
            ),
            (
                "%s/deleteinternetgatewaybastion" % base,
                "DELETE",
                DeleteInternetGatewayBastion,
                {},
            ),
        ]
