...
class DescribeAddressesResponseSchema(Schema):
    DescribeAddressesResponse = fields.Nested(DescribeAddressesResponse1Schema, required=True, many=False, allow_none=False)
...
class DescribeAddressesRequestSchema(Schema):
    ...
    ElasticIpId_N = fields.List(fields.String(example=''), required=False, allow_none=False, context='query',
                          collection_format='multi', data_key='ElasticIpId.N', description='One or more VPC IDs')
...
class DescribeAddresses(ServiceApiView):
    ...
    tags = ['computeservice']
    definitions = {
        'DescribeAddressesResponseSchema': DescribeAddressesResponseSchema
    }
    ...
    responses = ServiceApiView.setResponses({
        200: {
            'description': 'success',
            'schema': DescribeAddressesResponseSchema
        }
    })
...
class AllocateAddress(ServiceApiView):
    ...
    responses = ServiceApiView.setResponses({
        202: {
            'description': 'success',
            'schema': AllocateAddressApiResponseSchema
        }
    })
