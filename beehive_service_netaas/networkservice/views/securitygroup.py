...
from beehive_service.plugins.computeservice.controller import ApiComputeVPC, \
    ApiComputeSecurityGroup, ApiComputeService
...
from beehive_service.service_util import __REGEX_AWS_SG_NAME_AND_DESC__, __RULE_GROUP_INGRESS__, __RULE_GROUP_EGRESS__
...
class IpRangeResponseSchema(Schema):
    ...
    description = fields.String(example='', required=False, allow_none=True, description='Description of IPv4 CIDR')


class IpRangeRequestSchema(Schema):
    CidrIp = fields.String(example='', required=False, allow_none=True,
                           description='IPv4 CIDR (supported format:xxx.xxx.xxx.xxx/xx)', context='query')
    Description = fields.String(example='', required=False, allow_none=True, description='Description of IPv4 CIDR',
                                context='query')
...
class Ipv6RangeResponseSchema(Schema):
    ...
    description = fields.String(example='', required=False, allow_none=True, description='Description of IPv6 CIDR')
...
class Ipv6RangeRequestSchema(Schema):
    CidrIpv6 = fields.String(example='', required=False, allow_none=True, description='IPv6 CIDR', context='query')
    Description = fields.String(example='', required=False, allow_none=True, description='Description of IPv6 CIDR',
                                context='query')
...
class UserIdGroupPairResponseSchema(Schema):
    ...
    groupName = fields.String(example='', required=False, allow_none=True, description='name of the security group')
    ...
    nvl_userName = fields.String(example='', required=False, allow_none=True,
                                  description='account name or id', data_key='nvl-userName')
...
class UserIdGroupPairRequestSchema(Schema):
    ...
    GroupName = fields.String(example='', required=False,
                              description='security group rule name', context='query',
                              validate=Regexp(__REGEX_AWS_SG_NAME_AND_DESC__))
    # PeeringStatus = fields.String(example='', required=False, allow_none=True,
...
class IpPermissionsParameterResponseSchema(Schema):
    fromPort = fields.Integer(example='', required=False, allow_none=True,
                              description='start of port range for the protocols')
    toPort = fields.Integer(example='', required=False, allow_none=True,
                            description='end of port range for the protocols')
    ipProtocol = fields.String(example='', required=False, allow_none=True,
                               description='IP protocol for a security group rule')
    prefixListIds = fields.Nested(PrefixListIdSchema, many=True, required=False, allow_none=True,
                                  description='one or more prefix list IDs for a service')
    ipRanges = fields.Nested(IpRangeResponseSchema, many=True, required=False, allow_none=True,
                               description='one or more ipv4 range')
    ipv6Ranges = fields.Nested(Ipv6RangeResponseSchema, many=True, required=False, allow_none=True,
                               description='one or more ipv6 range')
    groups = fields.Nested(UserIdGroupPairResponseSchema, many=True, required=False, allow_none=True,
                           description='ine or more security group and account ID pairs')
    nvl_state = fields.String(required=False, allow_none=True,
                           description='state of security group rule',
                           data_key='nvl-state')
    nvl_reserved = fields.Boolean(required=False, allow_none=True,
...
class IpPermissionsParameterRequestSchema(Schema):
    FromPort = fields.Integer(required=False, missing=-1, example='', context='query',
                              description='start of port range for the protocols tcp, udp. Subprotocol for icmp')
    ToPort = fields.Integer(required=False, missing=-1, example='', context='query',
                            description='end of port range for the protocols')
    IpProtocol = fields.String(required=False, validate=OneOf(['tcp', 'udp', 'icmp', '-1']),
                               description='IP protocol for security group rule', context='query')
    prefixListIds = fields.Nested(PrefixListIdSchema, many=True, required=False,
                                  description='One or more prefix list IDs for a service', context='query')
    IpRanges = fields.Nested(IpRangeRequestSchema, many=True, required=False,
                             description='one or more ipv4 range', validation=(lambda n: 0 <= n <= 6553 or n == -1),
                             context='query')
    Ipv6Ranges = fields.Nested(Ipv6RangeRequestSchema, many=True, required=False, context='query',
                               description='one or more ipv6 range')
    UserIdGroupPairs = fields.Nested(UserIdGroupPairRequestSchema, many=True, required=False,
                                     context='query',
                                     description='One or more security group and account ID pairs')


class IpPermissionsSGParameterResponseSchema(Schema):
    ip_permission_cidr_N = fields.String(example='', required=False, allow_none=True,
                                         description='IPv4 CIDR block for an inbound security group rule')
    ip_permission_from_port_N = fields.String(example='', required=False, allow_none=True,
                                              description='For an inbound rule, the start of port range for the TCP '
                                                          'and UDP protocols, or an ICMP type number')
    ip_permission_group_id_N = fields.String(example='', required=False, allow_none=True,
                                             description='ID of a security group that has been referenced in an '
                                                         'inbound security group rule')
    ip_permission_group_name_N = fields.String(example='', required=False, allow_none=True,
                                               description='ID of a security group that has been referenced in an '
                                                           'inbound security group rule')
    ip_permission_ipv6_cidr_N = fields.String(example='', required=False, allow_none=True,
                                              description='IPv6 CIDR block for an inbound security group rule')
    ip_permission_prefix_list_id_N = fields.String(example='', required=False, allow_none=True,
                                                   description='The ID (prefix) of the service to which a security '
                                                               'group rule allows inbound access')
    ip_permission_protocol_N = fields.String(example='', required=False, allow_none=True,
                                             description='IP protocol for an inbound security group rule')
    ip_permission_to_port_N = fields.String(example='', required=False, allow_none=True,
                                            description='port range for the protocols')
    ip_permission_user_id_N = fields.String(example='', required=False, allow_none=True,
                                            description='ID of an  account that has been referenced in an inbound '
                                                        'security group rule')


class SecurityGroupStateReasonResponseSchema(Schema):
    nvl_code = fields.Integer(required=False, allow_none=True, example='400', description='state code',
                             data_key='nvl-code')
...
class SecurityGroupItemParameterResponseSchema(Schema):
    groupDescription = fields.String(required=False, allow_none=True, example='',
                                     description='instance security group description')
    groupId = fields.String(required=False, allow_none=True, example='',
                            description='instance security group identifier')
    groupName = fields.String(required=False, allow_none=True,
                              example='', description='instance security group name')
    ipPermissions = fields.Nested(IpPermissionsParameterResponseSchema,
                                  required=False, many=True, allow_none=True,
                                  description='One or more inbound rules associated with the security group')
    ipPermissionsEgress = fields.Nested(IpPermissionsParameterResponseSchema,
                                        required=False, many=True, allow_none=True,
    ...
    vpcId = fields.String(required=False, allow_none=True,
                          example='', descriptiom='ID of VPC')
    nvl_vpcName = fields.String(required=False, allow_none=True, example='', descriptiom='Name of the VPC',
                                data_key='nvl-vpcName')
    nvl_sgOwnerId = fields.String(required=False, allow_none=True, example='',
                                  descriptiom='ID of the account that owns the security group',
                                  data_key='nvl-sgOwnerId')
    nvl_sgOwnerAlias = fields.String(required=False, allow_none=True, example='',
    ...
    nvl_state = fields.String(
        ...
        data_key='nvl-state',
        validate=OneOf([getattr(ApiComputeSecurityGroup.state_enum, x) for x in dir(ApiComputeSecurityGroup.state_enum) if not x.startswith("__")]))
    # ['pending', 'available', 'deregistering', 'deregistered', 'transient', 'error', 'updating', 'unknown']
    nvl_stateReason = fields.Nested(SecurityGroupStateReasonResponseSchema, many=False, required=False,
...
class DescribeSecurityGroups1ResponseSchema(Schema):
    ...
    securityGroupInfo = fields.Nested(SecurityGroupItemParameterResponseSchema, many=True, required=False,
                                      allow_none=True)
    nvl_securityGroupTotal = fields.Integer(required=False, example='0', descriptiom='total security group',
...
class DescribeSecurityGroupsResponseSchema(Schema):
    DescribeSecurityGroupsResponse = fields.Nested(DescribeSecurityGroups1ResponseSchema, required=True, many=False,
                                                   allow_none=False)
...
class DescribeSecurityGroupsRequestSchema(Schema):
    ...
    #                                                          'outbound security group rule')
    group_id_N = fields.List(fields.String(example=''), required=False, allow_none=True,
                             context='query', collection_format='multi', data_key='group-id.N',
                             description='ID of the security group')
    group_name_N = fields.List(fields.String(example=''), required=False, allow_none=True,
                               context='query', collection_format='multi', data_key='group-name.N',
    ...
    vpc_id_N = fields.List(fields.String(example=''), required=False, allow_none=False,
                           context='query', collection_format='multi', data_key='vpc-id.N',
                           description='One or more VPC IDs')
    GroupId_N = fields.List(fields.String(example=''), required=False, allow_none=False,
                            context='query', collection_format='multi', data_key='GroupId.N',
                            description='One or more security group IDs')
    GroupName_N = fields.List(fields.String(example=''), required=False, allow_none=False,
                              context='query', collection_format='multi', data_key='GroupName.N',
...
class DescribeSecurityGroups(ServiceApiView):
    ...
    tags = ['computeservice']
    definitions = {
        'DescribeSecurityGroupsResponseSchema': DescribeSecurityGroupsResponseSchema
    }
...
class CreateSecurityGroupParamApiRequestSchema(Schema):
    ...
    GroupDescription = fields.String(required=False, default='', example='',
                                     description='a description for the security group')
    GroupName = fields.String(required=True, example='', description='name of the security group')
    VpcId = fields.String(required=True, example='', description='ID of the VPC',validate=Length(1, error='VpcId Must not be Empty'))
...
class CreateSecurityGroup(ServiceApiView):
    ...
    def post(self, controller, data, *args, **kwargs):
        ...
        inst = controller.add_service_type_plugin(service_definition.oid, account_id, name=sg_name,
                                                  desc=sg_desc, parent_plugin=inst_vpc, instance_config=data)
...
class PatchSecurityGroup(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': PatchSecurityGroupApiResponseSchema
        }
    })
...
class AuthorizeSGroupEgressApiResponseSchema(Schema):
    AuthorizeSecurityGroupEgressResponse = fields.Nested(AuthorizeSGroupEgressApi1ResponseSchema, required=True,
...
class AuthorizeSGroupEgressParamsApiRequestSchema(Schema):
    ...
    GroupName = fields.String(required=False, example='',
                              description='name of the security group', context='query')
    IpPermissions_N = fields.List(fields.Nested(IpPermissionsParameterRequestSchema),
                                  required=False, context='query',
                                  collection_format='multi', data_key='IpPermissions.N',
    ...
    def validate_unsupported_parameters(self, data, *args, **kvargs):
        keys = data.keys()
        print('keys=%s' % keys)
        if 'FromPort' in keys or \
                'ToPort' in keys or \
                'IpProtocol' in keys or \
                'SourceSecurityGroupName' in keys or \
                'SourceSecurityGroupOwnerId' in keys or \
                'CidrIp' in keys:
            raise ValidationError('Parameters FromPort, ToPort, IpProtocol, SourceSecurityGroupName, '
...
class AuthorizeSGroupIngressApiResponseSchema(Schema):
    AuthorizeSecurityGroupIngressResponse = fields.Nested(AuthorizeSGroupIngressApi1ResponseSchema, required=True,
                                                          many=False, allow_none=False)
...
class AuthorizeSGroupIngressParamsApiRequestSchema(Schema):
    ...
    IpPermissions_N = fields.List(fields.Nested(IpPermissionsParameterRequestSchema),
                                  ...
                                  description='sets of ip permission', context='query')
    ...
    def validate_unsupported_parameters(self, data, *args, **kvargs):
        ...
        if 'FromPort' in keys or \
                ...
                'SourceSecurityGroupName' in keys or \
                'CidrIp' in keys:
            raise ValidationError('The FromPort, ToPort, IpProtocol, SourceSecurityGroupName, '
...
class RevokeSGroupEgressApiResponseSchema(Schema):
    RevokeSecurityGroupEgressResponse = fields.Nested(RevokeSGroupEgressApi1ResponseSchema, required=True,
                                                      many=False, allow_none=False)
...
class RevokeSGroupEgressParamsApiRequestSchema(Schema):
    # GroupId = fields.String(required=True, example='', description='id of the security group')
    GroupName = fields.String(required=False, example='', description='name of the security group', context='query')
    IpPermissions_N = fields.List(fields.Nested(IpPermissionsParameterRequestSchema), required=False,
                                  context='query', collection_format='multi', data_key='IpPermissions.N',
                                  description='sets of ip permission')
...
class RevokeSecurityGroupEgress(ServiceApiView):
    ...
    responses = SwaggerApiView.setResponses({
        202: {
            'description': 'success',
            'schema': RevokeSGroupEgressApiResponseSchema
        }
    })
...
class RevokeSGroupIngressApiResponseSchema(Schema):
    RevokeSecurityGroupIngressResponse = fields.Nested(RevokeSGroupIngressApi1ResponseSchema, required=True,
                                                       many=False, allow_none=False)
...
class NetworkSecurityGroupAPI(ApiView):
    ...
    def register_api(module, rules=None, **kwargs):
        ...
        rules = [
            ...
            ('%s/authorizesecuritygroupingress' % base, 'POST', AuthorizeSecurityGroupIngress, {}),
            ('%s/authorizesecuritygroupegress' % base, 'POST', AuthorizeSecurityGroupEgress, {}),
            ('%s/revokesecuritygroupingress' % base, 'DELETE', RevokeSecurityGroupIngress, {}),
            ('%s/revokesecuritygroupegress' % base, 'DELETE', RevokeSecurityGroupEgress, {}),
        ]
